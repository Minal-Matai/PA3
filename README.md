...
Emphasize: A senior resident who has health issues (diabetes and high cholestrol) who needs to keep track of the types of food they buy and keep track of finances.
...
Problem Solution:
-Create a program where a senior can input the foods they need and the approximate price of each thing. The program will organize each thing into a diet
chart and measure how healthy or unhealthy the food items from the store are. The program will also create a budget tracker to keep count of everything.
